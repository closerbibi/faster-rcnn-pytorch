...
def load_my_state_dict(net, weight_path):
    import torch
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers): #gabriel
        super(ResNet, self).__init__() # gabriel
        #num_classes=1000
...
class Block4Fc7(nn.Module): # gabriel

    def __init__(self, block, layers):
        super(Block4Fc7, self).__init__()
...
def resnet152(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        weight_path = '/home/closerbibi/.torch/models/resnet152-b121ed2d.pth'
        load_my_state_dict(model, weight_path)
    return model

def resfc7(**kwargs):
    # resnet 101
    model = Block4Fc7(Bottleneck, [3, 4, 23, 3], **kwargs)
    return model
