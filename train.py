...
output_dir = 'models/resnet101-pascalvoc'
...
disp_interval = cfg.TRAIN.DISPLAY # reset to 50
...
weight_path = {
    ...
    'imageNet': '/home/closerbibi/.torch/models/resnet101-caffe.pth'
}
network.load_resnet_weight(net, weight_path['imageNet'])
...
for step in range(start_step, end_step+1):
    ...
    optimizer.step()
    total_loss = net.rpn.cross_entropy.data.cpu().numpy()[0]+ \
